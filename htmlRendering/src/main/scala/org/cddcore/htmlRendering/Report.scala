...
object Report {
  ...
  def htmlAndRenderedContext(title: Option[String], traceItems: List[TraceItem[Engine, Any, Any, Conclusion[_, _, _, _]]], description: Option[String] = None): (String, RenderContext) = {
