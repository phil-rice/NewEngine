...
abstract class EngineFoldingTest[Params, BFn, R, RFn, B <: Builder[R, RFn, R, B], E <: Engine[Params, BFn, R, RFn]] extends DecisionTreeBuilderAndBuilderBeingTested[Params, BFn, R, RFn, R, B, E] {
//
...
abstract class EngineFolding1Test[P, R] extends EngineFoldingTest[P, (P) => Boolean, R, (P) => R, Builder1[P, R, R], Engine1[P, R]] with Builder1Test[P, R, R]
abstract class EngineFolding2Test[P1, P2, R] extends EngineFoldingTest[(P1, P2), (P1, P2) => Boolean, R, (P1, P2) => R, Builder2[P1, P2, R, R], Engine2[P1, P2, R]] with Builder2Test[P1, P2, R, R]
abstract class EngineFolding3Test[P1, P2, P3, R] extends EngineFoldingTest[(P1, P2, P3), (P1, P2, P3) => Boolean, R, (P1, P2, P3) => R, Builder3[P1, P2, P3, R, R], Engine3[P1, P2, P3, R]] with Builder3Test[P1, P2, P3, R, R]

@RunWith(classOf[JUnitRunner])
class EngineFoldingStringStringTest extends EngineFolding1Test[String, String] with StringStringTest

@RunWith(classOf[JUnitRunner])
class EngineFoldingStringStringStringTest extends EngineFolding2Test[String, String, String] with StringStringStringTest

@RunWith(classOf[JUnitRunner])
class EngineFoldingStringStringStringStringTest extends EngineFolding3Test[String, String, String, String] with StringStringStringStringTest
