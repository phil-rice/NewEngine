...
abstract class AbstractTest1Test[P, R, FullR] extends AbstractTestTest[P, (P) => Boolean, R, (P) => R, Builder1[P, R, FullR], Engine1[P, R]] with Builder1Test[P, R, FullR]
...
class AbstractTestStringStringTest extends AbstractTest1Test[String, String, String] with StringStringTest with EvaluateTree1[String, String] {
