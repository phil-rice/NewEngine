...
object BuildEngine {
  ...
  private def build[Params, BFn, R, RFn, FullR,  B <: Builder[R, RFn, FullR, B]](builder: Builder[R, RFn, FullR, B], dt: DecisionTreeAndExceptions[Params, BFn, R, RFn], validator: ValidateScenario[Params, BFn, R, RFn]) = {
  ...
  def build2[P1, P2, R, FullR](builder: Builder2[P1, P2, R, FullR]) =
    build(builder,
  ...
  def build3[P1, P2, P3, R, FullR](builder: Builder3[P1, P2, P3, R, FullR]) =
    build(builder,
