...
case class Builder2[P1, P2, R](nodes: List[EngineNode[R, (P1, P2) => R]] = List(new EngineDescription[R, (P1, P2) => R])) extends Builder[R, (P1, P2) => R, Builder2[P1, P2, R]] {
  ...
  def scenario(p1: P1, p2: P2, title: String = null) = nextScenarioHolderL.andThen(nodesL).mod(this, (nodes) => nodes :+ new Scenario[(P1, P2), (P1, P2) => Boolean, R, (P1, P2) => R]((p1, p2), title = Some(title)))
