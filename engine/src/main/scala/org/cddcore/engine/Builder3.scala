...
class BuilderLens3[P1, P2, P3, R, FullR, B <: BuilderNodeHolder[R, (P1, P2, P3) => R]] extends FullBuilderLens[(P1, P2, P3), (P1, P2, P3) => Boolean, R, (P1, P2, P3) => R, FullR, B]
object Builder3 {
  def bl[P1, P2, P3, R, FullR]() = new BuilderLens3[P1, P2, P3, R, FullR, Builder3[P1, P2, P3, R, FullR]]
...
case class Builder3[P1, P2, P3, R, FullR](
  ...
  extends Builder[R, (P1, P2, P3) => R, FullR, Builder3[P1, P2, P3, R, FullR]]
  ...
  val bl3 = new BuilderLens3[P1, P2, P3, R, FullR, Builder3[P1, P2, P3, R, FullR]]
  import bl3._
  ...
  def copyNodes(nodes: List[BuilderNode[R, (P1, P2, P3) => R]]) = new Builder3[P1, P2, P3, R, FullR](nodes, buildExceptions)
  def build: Engine3[P1, P2, P3, R] = BuildEngine.build3(this)
  def copyWithNewExceptions(buildExceptions: Map[BuilderNode[R, (P1, P2, P3) => R], List[Exception]]) = new Builder3[P1, P2, P3, R, FullR](nodes, buildExceptions)
