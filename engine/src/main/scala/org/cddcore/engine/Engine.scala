...
trait EngineAndDecisionTree[Params, BFn, R, RFn] extends Engine[Params, BFn, R, RFn] with DecisionTree[Params, BFn, R, RFn] {
  def tree: DecisionTree[Params, BFn, R, RFn] = this
}

object Engine {
  /** returns a builder for an engine that implements Function[P,R] */
  def apply[P, R]()(implicit ldp: LoggerDisplayProcessor) = Builder1[P, R]()(ldp)
  /** returns a builder for an engine that implements Function2[P1,P2,R] */
  def apply[P1, P2, R]()(implicit ldp: LoggerDisplayProcessor) = Builder2[P1, P2, R]()(ldp)
  /** returns a builder for an engine that implements Function3[P1,P2,P3,R] */
  def apply[P1, P2, P3, R]()(implicit ldp: LoggerDisplayProcessor) = Builder3[P1, P2, P3, R]()(ldp)
